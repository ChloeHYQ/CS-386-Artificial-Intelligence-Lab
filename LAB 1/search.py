	...
	while(True):
		...
		if curr_node[0] not in explored:
			...
			for successor in successors:
				...
				temp_node = (successor[0],successor[1],successor[2]+curr_node[2],curr_node)
...
def uniformCostSearch(problem):
	...
	explored = set()
	fringe = util.PriorityQueueWithFunction(uni_cost)
	start_state = problem.getStartState()
	start_node = (start_state,"",0,"")
	fringe.push(start_node)
...
def aStarSearch(problem, heuristic=nullHeuristic):
	...
	explored = set()
	fringe = util.PriorityQueueWithFunction(astar_cost)
	start_state = problem.getStartState()
	start_node = (start_state,"",0,"")
	fringe.push(start_node)
